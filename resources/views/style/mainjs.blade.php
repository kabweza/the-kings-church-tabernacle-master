...
// if(sizeof($specialevents) != 0) {

//     $endingtime = $specialevents['0']['endingTime'];
//     $startingtime = $specialevents['0']['startingTime'];
// }
...
<script type="text/javascript">
    (function($) {
      ...
      $('#date-countdown').countdown('{{ $specialevent->endingTime }}', function(event) {
